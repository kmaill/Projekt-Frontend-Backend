...
export const AddonManager = () => {
  ...
  const handleDelete = async (id: number) => {
    if(!confirm("Na pewno chcesz usunąć ten dodatek?")) return;
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 overflow-hidden mt-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Baza Dodatków</h2>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-900/50 text-gray-500 dark:text-gray-400 text-sm">
              ...
              <th className="p-4 border-b dark:border-gray-700">Typ rozliczenia</th>
              <th className="p-4 border-b dark:border-gray-700">Cena</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            {addons.length === 0 && (
              <tr>
                <td colSpan={5} className="p-8 text-center text-gray-500 dark:text-gray-400">Brak danych / Ładowanie...</td>
              </tr>
            )}
          </tbody>
        </table>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md p-6 shadow-2xl relative border border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Nazwa dodatku</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Cena (PLN)</label>
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Rozliczenie</label>
                  <select {...register('billingType')} className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg outline-none focus:ring-2 focus:ring-emerald-500">
                    <option value="PER_RESERVATION">Za Rezerwację</option>
